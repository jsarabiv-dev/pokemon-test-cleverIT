...
@Component
public class TypeAttackMapperImpl implements TypeAttackMapper {

    @Override
    public TypeAttackDTO TypeAttackToTypeAttackDTO(TypeAttack typeAttack) {
        if ( typeAttack == null ) {
            return null;
        }
    ...
    protected TypePokemonDTO typePokemonToTypePokemonDTO(TypePokemon typePokemon) {
        if ( typePokemon == null ) {
            return null;
        }
        ...
        typePokemonDTO.setPokemons( pokemonListToPokemonDTOList( typePokemon.getPokemons() ) );
