...
public class PokemonMapperImpl implements PokemonMapper {
    ...
    protected List<MoveDTO> moveListToMoveDTOList(List<Move> list) {
        ...
        for ( Move move : list ) {
            ...
            /* Eliminar recursividad de Moves */
            move.getTypeAttack().setMove(null);
    ...
    protected SpriteDTO spriteToSpriteDTO(Sprite sprite) {
        ...
        /* Eliminar recursividad de Sprite */
        spriteDTO.setPokemon( null );
    ...
    protected TypePokemonDTO typePokemonToTypePokemonDTO(TypePokemon typePokemon) {
        ...
        /* Eliminar recursividad de typePokemon */
